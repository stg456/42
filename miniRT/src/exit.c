...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/04 16:02:05 by stgerard          #+#    #+#             */
/*   Updated: 2023/09/04 16:06:47 by stgerard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "miniRT.h"

static void	free_strs(char **tmp, char **tmp_pos,
				char **tmp_axe, char **tmpcolor)
{
	int	i;
